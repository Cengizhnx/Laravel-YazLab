...
<body>
    ...
    <form action="{{ url('contacts') }}" method="POST">
      ...
      <div class="icerik float-l">
        ...
        <p>
          ...
          <input type="text" name="ogrno" style="width:400px; height: 50px; font-size: 19px; margin-top: 15px;" disabled value="{{session('og_no')}}" placeholder="No"><br>
        </p>
        <p>
  ...
  <div class="kapsam" style="margin-left: 20px;">
    ...
    <h3>Başvurular Gelecek</h3>


    @forelse ($contac as $key => $item)
    <input type="text" name="drm" style="width:400px; height: 50px; font-size: 19px; margin-top: 15px;" value="{{ $item['durum'] }}" disabled placeholder="E-mail"><br>
    <input type="text" name="drm" style="width:400px; height: 50px; font-size: 19px; margin-top: 15px;" value="{{ $item['basvuru_turu'] }}" disabled placeholder="E-mail"><br>
    <hr>
    @empty
    <h3>Başvurular Gelecek</h3>
    @endforelse
